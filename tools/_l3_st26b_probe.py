"""Post N6038 with east15@(58,54): scan S/N exits for d14 IMPROVED."""
...
def main():
    ...
    for who, tgt in CANDS:
        ...
        if d1 < d0:
            ...
            soft.append((who, tgt, tag.lower()))
            # reboot — don't chain worse poses
            sess, data, ok = boot()
            if not ok:
                break
            d0, free, fr15 = dump(data, "repose")
