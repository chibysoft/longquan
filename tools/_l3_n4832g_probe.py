"""From N4832 with full deep15 (east@58,54): S toward goal column, skip x60."""
...
# From free~(36,44)+(48,32): move S(=36,44 south? max y) toward goal.
# south is (36,44), north is (48,32).
PLANS = [
    ("S5242", [("S", (52, 42))]),
    ("S5444", [("S", (54, 44))]),
    ("S5544", [("S", (55, 44))]),
    ...
    ("S4848", [("S", (48, 48))]),
    ("S5642", [("S", (56, 42))]),
    ("S6044", [("S", (60, 44))]),  # baseline
    ("vacE-S5553", [("E", (52, 58)), ("S", (55, 53))]),
    ("vacE-S5248", [("E", (52, 58)), ("S", (52, 48))]),
    ("S5242-N5238-S5553", [("S", (52, 42)), ("N", (52, 38)), ("S", (55, 53))]),
    ("S5242-S5550", [("S", (52, 42)), ("S", (55, 50))]),
    ("S5444-S5553", [("S", (54, 44)), ("S", (55, 53))]),
]
...
def main():
    ...
    for h in hits:
        print(h, flush=True)
    best = sorted(
        [h for h in hits if h[0] == "IMPROVED"], key=lambda x: (x[3], -x[5])
    )
