"""Chain west15: (48,42)->(42,50)->(36,54); then frog no-N; scan S/N."""
...
def main():
    ...
    for tgt in chain:
        ...
        print(f"wchain {west}->{tgt} {st}->{newc} bud={step_budget(data['frame'])}", flush=True)
        if st == "dead":
