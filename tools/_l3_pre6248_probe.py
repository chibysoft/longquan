"""From N6038 pose (before S6248), bud≈10: vacE / S-goal / alt stacks."""
...
def to_n6038(sess, data):
    """lagDirect → N4832 → S6044 → N6038. No S6248."""
    fr15 = lock_other_ship(data["frame"], 14)
    free = count_free14(data["frame"], fr15)
    lag = min(free, key=lambda w: w[0])
    data, _, st = move_wp(sess, data, lag, (36, 44), fr15)
    print(f"  lagDirect {st} bud={step_budget(data['frame'])}", flush=True)
    if st != "moved":
        return data, False
    fr15 = lock_other_ship(data["frame"], 14)
    free = count_free14(data["frame"], fr15)
...
PLANS = [
    ...
    ("vacE-S6248-S5652", [("E", (52, 58)), ("S", (62, 48)), ("S", (56, 52))]),
    ("vacE-S6248-S5553", [("E", (52, 58)), ("S", (62, 48)), ("S", (55, 53))]),
    ("S5652", [("S", (56, 52))]),
    ("S5553", [("S", (55, 53))]),
    ("S5450", [("S", (54, 50))]),
    ("S5250", [("S", (52, 50))]),
    ...
    ("N5642", [("N", (56, 42))]),
    ("N5542", [("N", (55, 42))]),
    ("vacE-N5542-S5553", [("E", (52, 58)), ("N", (55, 42)), ("S", (55, 53))]),
]
